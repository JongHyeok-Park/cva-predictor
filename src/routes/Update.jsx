    ...
    <main className="update">
      ...
      <form className="update-form">
        ...
        <div className="update-form-group">
          ...
          <input className="update-form-number" type="number" id="height" name="height" step="0.1" required onChange={handleChangeHeight} />
          <span className="update-form-unit">cm</span>
        </div>
        <div className="update-form-group">
          <label className="update-form-label" htmlFor="weight">몸무게</label>
          <input className="update-form-number" type="number" id="weight" name="weight" step="0.1" required onChange={handleChangeWeight} />
          <span className="update-form-unit">kg</span>
        </div>
        <div className="update-form-group">
          <h3 className="update-form-head">성별</h3>
          <label htmlFor="male">
            <input className="update-form-radio" type="radio" id="male" name="gender" value="true" required onChange={handleChangeGender} />
            남성
          </label>
          <label htmlFor="female">
            <input className="update-form-radio" type="radio" id="female" name="gender" value="false" required onChange={handleChangeGender} />
            여성
          </label>
        </div>
        <div className="update-form-group">
          ...
          <label htmlFor="solo-yes">
            <input className="update-form-radio" type="radio" id="solo-yes" name="solo" value="true" required onChange={handleChangeSolo} />
            미혼
          </label>
          <label htmlFor="solo-no">
            <input className="update-form-radio" type="radio" id="solo-no" name="solo" value="false" required onChange={handleChangeSolo} />
            기혼
          </label>
        </div>
        <div className="update-form-group">
          ...
          <label htmlFor="city-yes">
            <input className="update-form-radio" type="radio" id="city-yes" name="city" value="true" required onChange={handleChangeCity} />
            도심
          </label>
          <label htmlFor="city-no">
            <input className="update-form-radio" type="radio" id="city-no" name="city" value="false" required onChange={handleChangeCity} />
            시외
          </label>
        </div>
        <div className="update-form-group">
        ...
        <div className="update-form-group">
          ...
          <select className="update-form-select" onChange={handleChangeWorkType}>
        ...
        <div className="update-form-button">
          <button type="reset" className="update-form-reset" onClick={() => {navigate('/info')}}>취소</button>
          <button type="submit" className="update-form-submit" onClick={handleSubmitBtn}>저장</button>
        </div>
      </form>
